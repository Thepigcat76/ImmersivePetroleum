...
public class IPAdvancements extends AdvancementProvider{
	...
	private static void registerAdvancements(HolderLookup.Provider lookup, Consumer<AdvancementHolder> consumer, ExistingFileHelper exHelper){
		...
		AdvancementHolder derrick = advancement(start, IPContent.Multiblock.DERRICK.block(), "mb_derrick", AdvancementType.GOAL, true, true, false)
			.addCriterion("derrick", createMultiblockTrigger("derrick"))
			.save(consumer, ResourceUtils.ip("main/mb_derrick"), exHelper);
		
		AdvancementHolder pumpjack = advancement(derrick, IPContent.Multiblock.PUMPJACK.block(), "mb_pumpjack", AdvancementType.GOAL, true, true, false)
			.addCriterion("pumpjack", createMultiblockTrigger("pumpjack"))
			.save(consumer, ResourceUtils.ip("main/mb_pumpjack"), exHelper);
		
		advancement(derrick, IPContent.Multiblock.OILTANK.block(), "mb_oiltank", AdvancementType.GOAL, true, true, false)
			.addCriterion("oiltank", createMultiblockTrigger("oiltank"))
			.save(consumer, ResourceUtils.ip("main/mb_oiltank"), exHelper);
		
		AdvancementHolder tower = advancement(pumpjack, IPContent.Multiblock.DISTILLATIONTOWER.block(), "mb_distillationtower", AdvancementType.GOAL, true, true, false)
		...
		AdvancementHolder cokerunit = advancement(bitumen, IPContent.Multiblock.COKERUNIT.block(), "mb_cokerunit", AdvancementType.GOAL, true, true, false)
		...
		AdvancementHolder hydrotreater = advancement(tower, IPContent.Multiblock.HYDROTREATER.block(), "mb_hydrotreater", AdvancementType.GOAL, true, true, false)
	...
	protected static Advancement.Builder advancement(AdvancementHolder parent, Supplier<? extends ItemLike> display, String name, AdvancementType frame, boolean showToast, boolean announceToChat, boolean hidden){
		return advancement(parent, display.get(), name, frame, showToast, announceToChat, hidden);
	}
