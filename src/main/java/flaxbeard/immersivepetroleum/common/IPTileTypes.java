...
public class IPTileTypes{
	// Multiblocks
	public static final Supplier<BlockEntityType<? extends MultiblockBlockEntityMaster<DerrickLogic.State>>> DERRICK = getMBTE(Multiblock.DERRICK);
	public static final Supplier<BlockEntityType<? extends MultiblockBlockEntityMaster<PumpjackLogic.State>>> PUMPJACK = getMBTE(Multiblock.PUMPJACK);
	public static final Supplier<BlockEntityType<? extends MultiblockBlockEntityMaster<OilTankLogic.State>>> OILTANK = getMBTE(Multiblock.OILTANK);
	public static final Supplier<BlockEntityType<? extends MultiblockBlockEntityMaster<DistillationTowerLogic.State>>> DISTILLATIONTOWER = getMBTE(Multiblock.DISTILLATIONTOWER);
	public static final Supplier<BlockEntityType<? extends MultiblockBlockEntityMaster<CokerUnitLogic.State>>> COKERUNIT = getMBTE(Multiblock.COKERUNIT);
	public static final Supplier<BlockEntityType<? extends MultiblockBlockEntityMaster<HydroTreaterLogic.State>>> HYDROTREATER = getMBTE(Multiblock.HYDROTREATER);
	...
	private static <S extends IMultiblockState> Supplier<BlockEntityType<? extends MultiblockBlockEntityMaster<S>>> getMBTE(MultiblockRegistration<S> mbReg){
		return mbReg.masterBE();
	}
